...
class _BasicPhrasesPageState extends State<BasicPhrasesPage> {
  final List<String> phrases = basicPhrasesMappings.keys.toList();
  String? userId;
  ...
  Future<void> _loadUserId() async {
    ...
    // Shimmer should display for at least 1.5s
  ...
  Future<void> _toggleFavorite(String phrase) async {
    ...
    String mappedValue = basicPhrasesMappings[phrase] ?? "";
  ...
  /// Shimmer matching AlphabetNumbersPage aesthetic
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        ...
                        onTap: () {
                          String publicId = basicPhrasesMappings[phrase] ?? '';
